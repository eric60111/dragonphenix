...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '原料進貨彙總表', 0, false, 'C', 0, '', 0, false, 'C', 'B');
...
$sql = 
"SELECT I.IngredientPurchaseID, C.CompanyName, I.SetupDate ".
"From IngredientPurchases I, Companies C, Employees E ".
"WHERE ";
...
foreach ($resp as $value) {
	$IngredientPurchaseID = $value['IngredientPurchaseID'];
	$CompanyName = $value['CompanyName'];
	$SetupDate = $value['SetupDate'];
	
	$Detailsql = 
	"SELECT IPD.IngredientPurchaseDetailID, I.IngredientID, I.Name As IngredientName, IPD.UnitPrice, IPD.ActualQuantity, I.Unit ".
