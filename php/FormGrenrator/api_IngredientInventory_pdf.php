...
$IngredientInventoryID = !empty($_GET['IngredientInventoryID']) ? $_GET['IngredientInventoryID'] : null; 
...
"WHERE I.IngredientInventoryID = '$IngredientInventoryID' AND ".
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '原料盤點單', 0, false, 'C', 0, '', 0, false, 'L', 'C');
...
$tbl_header = 
	'<table cellpadding="5" border="1">'.
		'<tr>'.
			'<td colspan="4"  align="center">原料盤點明細</td>'.
		'</tr>'.
		'<tr bgcolor="#F2F2F2">'.
			'<td>品名</td>'.
...
ob_clean();
$pdf->Output($_SERVER['DOCUMENT_ROOT'].$_SERVER['DOCUMENT_ROOT'].'IngredientInventory.pdf', 'I');
