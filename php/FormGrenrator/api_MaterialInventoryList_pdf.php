...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '配方料盤點彙總表', 0, false, 'C', 0, '', 0, false, 'C', 'B');
...
$sql = 
"SELECT I.MaterialInventoryID, I.Date, E.Name As EmployeeName ".
...
foreach ($resp as $value) {
	$MaterialInventoryID = $value['MaterialInventoryID'];
	$EmployeeName = $value['EmployeeName'];
	$Date = $value['Date'];
	
	$Detailsql = 
	"SELECT IID.MaterialInventoryDetailID, I.MaterialID, I.Name As MaterialName, IID.Inventory, IID.Difference, I.Unit ".
