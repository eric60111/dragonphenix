...
$MaterialShipmentID = !empty($_GET['MaterialShipmentID']) ? $_GET['MaterialShipmentID'] : null; 
...
$sql = 
"SELECT M.MaterialShipmentID, C.CompanyName, C.ContactName, C.Phone, C.Address, C.TaxID, E.Name, M.SetupDate, M.VerifyDate, M.VerifyEmployee ".
"From (
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '配方料出貨單', 0, false, 'C', 0, '', 0, false, 'L', 'C');
...
$Detailsql = 
"SELECT MSD.MaterialShipmentDetailID, M.Name As MaterialName, MSD.SoldPrice, MSD.Quantity, M.Unit ".
...
$tbl_header = 
	'<table cellpadding="5" border="1">'.
		'<tr>'.
			'<td colspan="4"  align="center">配方料出貨明細</td>'.
		'</tr>'.
		'<tr bgcolor="#F2F2F2">'.
			'<td>品名</td>'.
