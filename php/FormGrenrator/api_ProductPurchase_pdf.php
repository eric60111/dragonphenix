...
$ProductPurchaseID = !empty($_GET['ProductPurchaseID']) ? $_GET['ProductPurchaseID'] : null; 
...
$sql = 
"SELECT P.ProductPurchaseID, C.CompanyName, C.ContactName, C.Phone, C.Address, C.TaxID, E.Name, P.SetupDate, P.VerifyDate, P.VerifyEmployee ".
"From (
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '產品進貨單', 0, false, 'C', 0, '', 0, false, 'L', 'C');
...
$Detailsql = 
"SELECT PPD.ProductPurchaseDetailID, P.Name As ProductName, PPD.UnitPrice, PPD.Quantity, P.Unit ".
...
$tbl_header = 
	'<table cellpadding="5" border="1">'.
		'<tr>'.
			'<td colspan="4"  align="center">產品進貨明細</td>'.
		'</tr>'.
		'<tr bgcolor="#F2F2F2">'.
			'<td>品名</td>'.
