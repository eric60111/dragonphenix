...
$IngredientShipmentID = !empty($_GET['IngredientShipmentID']) ? $_GET['IngredientShipmentID'] : null; 
...
$sql = 
"SELECT I.IngredientShipmentID, C.CompanyName, C.ContactName, C.Phone, C.Address, C.TaxID, E.Name, I.SetupDate, I.VerifyDate, I.VerifyEmployee ".
"From (
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '原料出貨單', 0, false, 'C', 0, '', 0, false, 'L', 'C');
...
$Detailsql = 
"SELECT ISD.IngredientShipmentDetailID, I.Name As IngredientName, ISD.SoldPrice, ISD.Quantity, I.Unit ".
...
$tbl_header = 
	'<table cellpadding="5" border="1">'.
		'<tr>'.
			'<td colspan="4"  align="center">原料出貨明細</td>'.
		'</tr>'.
		'<tr bgcolor="#F2F2F2">'.
			'<td>品名</td>'.
