...
$MaterialInventoryID = !empty($_GET['MaterialInventoryID']) ? $_GET['MaterialInventoryID'] : null; 
...
$sql = 
"SELECT I.MaterialInventoryID, I.Barcode, E.EmployeeID, E.Name as EmployeeName, I.Date ".
"From MaterialInventories I, Employees E ".
"WHERE I.MaterialInventoryID = '$MaterialInventoryID' AND ".
"I.EmployeeID = E.EmployeeID AND ".
"I.State = 1 ".
"ORDER BY I.MaterialInventoryID ASC ;";
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '配方料盤點單', 0, false, 'C', 0, '', 0, false, 'L', 'C');
...
$Detailsql = 
"SELECT IID.MaterialInventoryDetailID, IID.MaterialInventoryID, I.MaterialID, I.Name As MaterialName, IID.Inventory, IID.Difference, I.Unit ".
"FROM MaterialInventoryDetails IID, Materials I ".
"WHERE IID.MaterialInventoryID = '$MaterialInventoryID' AND ".
"IID.MaterialID = I.MaterialID AND ".
"IID.State = 1 ".
"ORDER BY IID.MaterialInventoryDetailID ASC ;";
...
$tbl_header = 
	'<table cellpadding="5" border="1">'.
		'<tr>'.
			'<td colspan="4"  align="center">配方料盤點明細</td>'.
		'</tr>'.
		'<tr bgcolor="#F2F2F2">'.
			'<td>品名</td>'.
...
ob_clean();
$pdf->Output($_SERVER['DOCUMENT_ROOT'].'MaterialInventory.pdf', 'I');
