...
$MaterialPurchaseID = !empty($_GET['MaterialPurchaseID']) ? $_GET['MaterialPurchaseID'] : null; 
...
$sql = 
"SELECT M.MaterialPurchaseID, C.CompanyName, C.ContactName, C.Phone, C.Address, C.TaxID, E.Name, M.SetupDate, M.VerifyDate, M.VerifyEmployee ".
"From (
...
$barcode = date_format(date_create($SetupDate), "ymd").'5'.sprintf("%03d", $MaterialPurchaseID);
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 30, '配方料進貨單', 0, false, 'C', 0, '', 0, false, 'L', 'C');
...
$Detailsql = 
"SELECT MPD.MaterialPurchaseDetailID, M.Name As MaterialName, MPD.UnitPrice, MPD.Quantity, M.Unit ".
...
$tbl_header = 
	'<table cellpadding="5" border="1">'.
		'<tr>'.
			'<td colspan="4"  align="center">配方料進貨明細</td>'.
		'</tr>'.
		'<tr bgcolor="#F2F2F2">'.
			'<td>品名</td>'.
